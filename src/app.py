...
PROJECT = "browser-risky-extension-ecosystem-map"
TITLE = "Browser Risky Extension Ecosystem Map"
DOMAIN = "internet"
TTE_DAYS = 4
EXPOSURE_SCORE = 8
WAVE = 1
PRIORITY_SCORE = 7.20
RISK_FOCUS = "signal credibility, abuse resistance, and propagation speed"
